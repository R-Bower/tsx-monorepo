...
- Consistent styles are easier to maintain if they're enforced at the compiler level.
  - If you try to use a color that doesn't exist in our colors interface, your code won't compile.
  - One-off HEX values often yield inconsistencies that compromise the user experience.  They're also cumbersome to refactor.
- TODO: add more.
